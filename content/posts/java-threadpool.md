...
本篇为 [Java：初识多线程、原理及实现](https://hoffmanzheng.github.io/2020/java-multi-thread/) 的续篇，介绍 Java 中的线程池，主要内容有：进程与线程、线程池化的意义、Executors 工具类、线程池工作流程、线程复用原理等。
...
在 [Java：并发编程实战](https://hoffmanzheng.github.io/2021/java-concurrency/) 中介绍了无限制地创建线程将导致系统的不稳定性。虽然可以通过使用固定大小的线程池来解决这个问题，然而在高负载下如果新请求的到达速率超过了线程池的处理速率，请求会 **在队列中累计** 起来，应用程序仍可能耗尽资源。
